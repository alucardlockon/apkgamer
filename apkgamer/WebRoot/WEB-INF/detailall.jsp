...
<html>
	<head>
		...
		<title>${oneapk.title}|APK玩家</title>
	...
	<body>
		<div id="header" style="width: 100%">
			<a href="${pageContext.request.contextPath}/apkAction"><img
					border="0"
		...
		<div id="body" style="width: 100%;">
			<div id="list"
				...
				<s:action name="showAction!detail" namespace="/"
					executeResult="true"></s:action>
			</div>
			<div id="rightlist" style="width: 29%; float: right">
				<s:action name="showAction!rightlist" namespace="/"
					executeResult="true"></s:action>
			</div>
		</div>
	</body>
